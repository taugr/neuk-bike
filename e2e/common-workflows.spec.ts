...
test('searches from a place and selects a nearby parking row', async ({
  ...
  const listHeading = finderPanel.locator('.list-heading');
  ...
  const [
    headingWithSuggestions,
    optionWithSuggestions,
    listHeadingWithSuggestions,
  ] = await Promise.all([
